...
#' @param lith_group \code{character}. string, group of lithologies (e.g., unconsolidated)
#' @param lith_type \code{NA}. string, type of lithologies (e.g., carbonate, siliciclastic)
