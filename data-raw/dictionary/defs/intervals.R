...
#' @param t_age \code{numeric}. The minimum age bound interval data should be returned for in millions of years before present. If set to NULL (default), all interval data for the respective timescale is returned.
#' @param b_age \code{numeric}. The maximum age bound interval data should be returned for in millions of years before present. If set to NULL (default), all interval data for the respective timescale is returned.
