...
```
##   strat_name      strat_name_long rank strat_name_id concept_id bed bed_id
...
## 3      0  72.1    66 Cretaceous Paleogene                 13      1
```
...
## 1 #F2FA8C    66  72.1 Maastrichtian MULTIPOLYGON (((-110.0168 4...
```
