...
```
##   strat_name      strat_name_long rank strat_name_id concept_id bed bed_id        mbr mbr_id
## 1 Hell Creek Hell Creek Formation   Fm         71267       8598          0                 0
## 2 Hell Creek    Hell Creek Member  Mbr         71268       8598          0 Hell Creek  71268
## 3 Hell Creek Hell Creek Formation   Fm           867       8598          0                 0
##           fm fm_id subgp subgp_id                gp gp_id sgp sgp_id b_age t_age   b_period  t_period
## 1 Hell Creek 71267              0           Montana  2565          0 100.5    56 Cretaceous Paleogene
## 2      Lance  1090              0 Black Buttes coal 69391          0 100.5    56 Cretaceous Paleogene
## 3 Hell Creek   867              0                       0          0  72.1    66 Cretaceous Paleogene
##   c_interval t_units ref_id
## 1                  0     19
## 2                  0     19
## 3                 13      1
```
...
## 1 2092425        25 Hell Creek Formation Hell Creek Formation Major:: {sandstone, mudstone}        
##   comments macro_units       strat_names liths t_int_id t_int_age      t_int_name b_int_id b_int_age
## 1                 9213 867, 71267, 71268 7, 10       34        66 Late Cretaceous       34     100.5
##        b_int_name   color t_age b_age best_int_name                       geometry
## 1 Late Cretaceous #F2FA8C    66  72.1 Maastrichtian MULTIPOLYGON (((-110.0168 4...
```
...
```
## Error in annotation_north_arrow(location = "br", pad_y = unit(0.75, "cm"), : could not find function "annotation_north_arrow"
```
